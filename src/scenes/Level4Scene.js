...
export class Level4Scene extends Phaser.Scene {
  ...
  create() {
    ...
    const collectiblePositions = [
      ...
      { x: 2220, y: 200 }, { x: 2470, y: 280 }, { x: 2700, y: 220 },
      { x: 2920, y: 180 }, { x: 3140, y: 260 },
    ];
    ...
    this.instrument = this.physics.add.sprite(3220, GAME_HEIGHT - 100, 'harpsichord');
    ...
    const checkpointPositions = [
      ...
      { x: 1100, y: GAME_HEIGHT - 64 },
      { x: 2000, y: GAME_HEIGHT - 64 },
      { x: 2720, y: GAME_HEIGHT - 64 },
    ];
